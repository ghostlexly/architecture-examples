 ...
 */
const create = async (
  { body, account }: TypedRequest<typeof storeSchema>,
  res: Response,
  next: NextFunction
) => {
  /**
...
const updateProfessionalInfos = async (
  { body, params, account }: TypedRequest<typeof storeProInfosSchema>,
  res: Response,
  next: NextFunction
) => {
  // ---------------------
...
const updateInterventions = async (
  { body, params, account }: TypedRequest<typeof hkInterventionsSchema>,
  res: Response,
  next: NextFunction
) => {
  // -- check if housekeeper informations exists already for this user
